...
# Date: 20190212
# Python3
# Name: serial_number_and_version_finder_ver_1_03.py
...
dict = {"ricardo": 27, "lucero": 26, "eva": 1}
...
def def_test():
    print ("This function should not run unless called upon")
    pprint.pprint(dict, width=10)

#def_test()

def def_sn_model_dict():
    global sn_model_dict
    sn_model_dict = {}
    switch_sn_entries = len(switch_sn)
    entries_count = (0)
    while entries_count < switch_sn_entries:
        sn_model_dict[switch_sn[entries_count]] = switch_model[entries_count]
        entries_count +=1
    #pprint.pprint(sn_model_dict, width=10) 
...
for file in file_list:
    ...
    with open(file, 'r') as f_device:
        ...
        # Use lists (switch_sn & switch_model) to create a SN/Model dictionary
        def_sn_model_dict()
        #print (sn_model_dict)
        #pprint.pprint(sn_model_dict, width=10)
        #print (switch_sn)
